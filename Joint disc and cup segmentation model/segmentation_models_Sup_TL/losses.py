...
class GeneralizedDiceLoss(Loss):
    ...
    def __init__(self, class_weights=None, class_indexes=None, per_image=False, smooth=SMOOTH):
        super().__init__(name='general_dice_loss')
        self.class_weights = class_weights if class_weights is not None else 1
        self.class_indexes = class_indexes
        self.per_image = per_image
        self.smooth = smooth
...
class TverskyLoss(Loss):
    ...
    def __init__(self,alpha=1 ,beta=1, class_weights=None, class_indexes=None, per_image=False, smooth=SMOOTH):
...
class FocalTverskyLoss(Loss):
    ...
    def __init__(self,alpha=1 ,beta=1, gamma=0.75,class_weights=None, class_indexes=None, per_image=False, smooth=SMOOTH):
        super().__init__(name='focaltversky_loss')
        self.alpha = alpha
        self.beta = beta
        self.gamma = gamma
        self.class_weights = class_weights if class_weights is not None else 1
...
class SuppressedTverskyLoss(Loss):
    r"""Creates a criterion to measure Dice loss:
    ...
    def __init__(self,alpha=1 ,beta=1, gamma=2,class_weights=None, class_indexes=None, per_image=False,k=0.25 , smooth=SMOOTH):
        super().__init__(name='suppressedtversky_loss')
        self.alpha = alpha
        self.k = k
        self.beta = beta
        self.gamma = gamma
    ...
    def __call__(self, gt, pr):
        return F.suppressed_tversky_loss(
            gt,
            pr,
            alpha=self.alpha,
            k=self.k,
...
class LogTverskyLoss(Loss):
    ...
    def __init__(self,alpha=1 ,beta=1, class_weights=None, class_indexes=None, per_image=False, smooth=SMOOTH):
        super().__init__(name='log_tversky_loss')
        self.alpha = alpha
        self.beta = beta
        self.class_weights = class_weights if class_weights is not None else 1
        self.class_indexes = class_indexes
